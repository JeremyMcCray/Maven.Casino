...
public class Casino {
    Membership tempMember = new Membership("Jeremy", 4000,500,32);
    Storage storage;
    String casinoName = "";
    ...
    public void welcomeMessage() {
        ...
        storage.addMemberToStorage(tempMember);
    }
    ...
    public static void main(String[] args) {
        ...
        Casino vegas = new Casino("Vegas HighRollers");
        vegas.welcomeMessage();

        Membership defaultUser = new Membership("Default User", 1111, 500, 25);
        vegas.storage.addMemberToStorage(defaultUser);

        boolean stayInCasino = true;
        while (stayInCasino == true) {
            ...
            if (isMember == false) {
                ...
                if (foundAccount == false) {
                    ...
                    vegas.currentMember = vegas.storage.getMember(supposedID);
                    System.out.println("               Entering Casino            ");
                    keepPlaying = true;
                }
            }
            ...
            while (keepPlaying == true) {
                ...
                if (gamechoice == 1) {
                    ...
                    vegas.blackJackGame.startGame(vegas.currentMember);
                    keepPlaying = vegas.playAgain();
            ...
            System.out.println("Would you Like to Stay In the Casino ? Or Leave ?");
            String stayOrLeave = vegas.getUserInput();
            if(stayOrLeave.equals("stay")){
                stayInCasino = true;
            }
            else{
                stayInCasino = false;
